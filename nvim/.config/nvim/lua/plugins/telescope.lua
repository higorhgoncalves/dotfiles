return {
	{
		...
		keys = {
			...
			{ "<leader>fC", "<cmd>Telescope commands<cr>", desc = "Find available plugin/user commands" },
			{ "<leader>f:", "<cmd>Telescope command_history<cr>", desc = "Find commands that were executed recently" },
			...
			{ "<leader>fo", "<cmd>Telescope oldfiles<cr>", desc = "Find in previously open files" },
			...
			{ "<leader>fI", "<cmd>Telescope lsp_incoming_calls<cr>", desc = "Find LSP incoming calls" },
			{ "<leader>fO", "<cmd>Telescope lsp_outgoing_calls<cr>", desc = "Find LSP outgoing calls" },
			...
			{ "<leader>ft", "<cmd>Telescope lsp_type_definitions<cr>", desc = "Find LSP type definitions" },
			{ "<leader>fs", "<cmd>Telescope lsp_document_symbols<cr>", desc = "Find LSP document symbols" },
			{ "<leader>fw", "<cmd>Telescope lsp_workspace_symbols<cr>", desc = "Find LSP workspace symbols" },
			{
				"<leader>fW",
			...
			{ "<leader>fGC", "<cmd>Telescope git_bcommits<cr>", desc = "Find Git Buffer's Commits" },
